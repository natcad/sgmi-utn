...
const gruposService = require("./grupos.services.cjs");
...
const crearGrupo = async (req, res) => {
  try {
    ...
    console.log("📦 Datos que se envían al servicio:", datosNuevoGrupo);
...
const actualizarGrupo = async (req, res) => {
  try {
    ...
    const [grupoActualizado] = await gruposService.actualizar(
      id,
      datosActualizados
    );
